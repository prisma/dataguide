...
When using [Prisma](https://github.com/prisma/prisma), you can use the [Prisma Migrate](https://www.prisma.io/docs/orm/prisma-migrate) to create your databases and tables. [Developing with Prisma Migrate](https://www.prisma.io/docs/orm/prisma-migrate/workflows) generates migration files based on the declarative [Prisma schema](https://www.prisma.io/docs/orm/prisma-schema/overview) and applies them to your database.
