...
metaTitle: 'SQLite: How to Create, Delete and Manage Databases'
metaDescription: 'Learn how to create, destroy, manage, and use databases and tables using SQLite.'
...
In this article, we are going to cover the creation and destruction of _databases_ and _tables_ in SQLite. We can quickly refresh our memory of these two terms:
...
When using [Prisma](https://github.com/prisma/prisma), you can use the [Prisma Migrate](https://www.prisma.io/docs/concepts/components/prisma-migrate) to create your databases and tables. [Developing with Prisma Migrate](https://www.prisma.io/docs/guides/migrate/developing-with-prisma-migrate) generates migration files based on the declarative [Prisma schema](https://www.prisma.io/docs/concepts/components/prisma-schema) and applies them to your database.
