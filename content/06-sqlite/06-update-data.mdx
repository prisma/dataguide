...
This syntax allows you to update in bulk depending on the `WHERE` critera to determine which records match.
...
The basic syntax looks like this with `*` to return all of the columns:
