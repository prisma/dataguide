...
metaTitle: "SQLite SELECT Statement | Basic Querying with Examples"
metaDescription: "Learn how to perform basic queries with `SELECT` using SQLite, including information on basic syntax with examples."
---
...
The basic format of a `SELECT` command will look something like this:
