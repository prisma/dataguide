...
When using [Prisma Client](/docs/concepts/components/prisma-client), you can control the columns that are returned with the [select fields](/docs/concepts/components/prisma-clientselect-fields) functionality.
