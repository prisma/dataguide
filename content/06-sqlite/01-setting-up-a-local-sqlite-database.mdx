...
![SQLite download page](/content/sqlite/setting-up-a-local-database/windows/download_page.png)
...
![SQLite zip file](/content/sqlite/setting-up-a-local-database/windows/downloads.png)

Right-click the file and select **Extract All...** to bring up a new extract window:

![SQLite extract window](/content/sqlite/setting-up-a-local-database/windows/extract_menu.png)
...
![SQLite select desktop](/content/sqlite/setting-up-a-local-database/windows/extract_folder.png)
...
![SQLite tools in folder](/content/sqlite/setting-up-a-local-database/windows/sqlite_directory.png)

If you click the `sqlite3.exe` application, a new window will appear with an interactive SQLite session:

![new SQLite session](/content/sqlite/setting-up-a-local-database/windows/sqlite_no_db.png)
...
![SQLite open new database](/content/sqlite/setting-up-a-local-database/windows/sqlite_open_new_db.png)
...
![SQLite open database](/content/sqlite/setting-up-a-local-database/windows/sqlite_open_db.png)
...
![SQLite open database](/content/sqlite/setting-up-a-local-database/windows/sqlite_from_cmd.png)
...
![SQLite download page](/content/sqlite/setting-up-a-local-database/macos/download_page.png)

Save the file to a convenient location.

Open the Finder file manager and navigate to the location of the zipped archive:

![SQLite zip file](/content/sqlite/setting-up-a-local-database/macos/zip_file.png)
...
![SQLite SQLite tools](/content/sqlite/setting-up-a-local-database/macos/sqlite_tools.png)
...
![SQLite download page](/content/sqlite/setting-up-a-local-database/linux/download_page.png)
