...
You can also use the Prisma Client to add data to your tables by issuing a [create query](/docs/concepts/components/prisma-client/crud#create).
...
To remove data from your tables using Prisma Client, use a [delete query](/docs/concepts/components/prisma-client/crud#delete).
...
Prisma Client uses a separate query called [deleteMany](/docs/concepts/components/prisma-client/crud#deletemany) to delete multiple rows of data at one time.
