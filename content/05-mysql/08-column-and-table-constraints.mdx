...
metaTitle: "MySQL Constraint Types - Foreign Key, Check, Drop, & More"
metaDescription: "Column and table constraints give you control over what values you allow in your database tables.  Here we'll learn how to define and use constraints in MySQL."
---

## What are MySQL column and table constraints?

Constraints are user defined requirements that define what values are valid for a column or table.  You can think of them as additional restrictions to narrow in on acceptable values more strictly than [data types](/mysql/introduction-to-data-types) allow.
