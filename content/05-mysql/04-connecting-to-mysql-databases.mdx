...
metaTitle: "MySQL: Connect Databases (Remote and Local) with Examples"
metaDescription: "Learn how to connect to local and remote MySQL databases using the `mysql` client, as well as how to adjust MySQL server's authentication configuration."
---
