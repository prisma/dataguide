...
- **COLLATE:** sets the _collation_, or sort order for the database. This is a localization option that determines how items are organized when they are ordered.
