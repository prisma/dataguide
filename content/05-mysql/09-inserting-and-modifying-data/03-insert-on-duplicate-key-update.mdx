...
If we want anticipate this possibility and want to update the existing row with the new information, we can avoid this error.  The `ON DUPLICATE KEY UPDATE` clause allows us to do this:
