...
For example, if you want to export data from a MySQL database that has the following [connection string](https://www.prisma.io/docs/concepts/database-connectors/mysql):
