---
title: 'MySQL Update Statement - Query Syntax to Modify Data'
metaTitle: "MySQL Update Statement - How to Use Correct Query Syntax"
metaDescription: "The `UPDATE` command allows you to change the data in existing MySQL records.  This guide demonstrates how to use it to modify the values within your tables."
---
