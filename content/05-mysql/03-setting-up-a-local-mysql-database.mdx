...
![MySQL list of installers](/content/mysql/setting-up-a-local-database/windows/list_of_installers.png)
...
![MySQL download windows installer](/content/mysql/setting-up-a-local-database/windows/download_installer.png)
...
![MySQL skip account creation](/content/mysql/setting-up-a-local-database/windows/skip_account_creation.png)
...
![MySQL choose setup type](/content/mysql/setting-up-a-local-database/windows/installer_1.png)
...
![MySQL installation confirmation](/content/mysql/setting-up-a-local-database/windows/installer_2.png)
...
![MySQL begin configuration](/content/mysql/setting-up-a-local-database/windows/installer_3.png)
...
![MySQL choose availability](/content/mysql/setting-up-a-local-database/windows/installer_4.png)
...
![MySQL machine type](/content/mysql/setting-up-a-local-database/windows/installer_5.png)
...
![MySQL auth method](/content/mysql/setting-up-a-local-database/windows/installer_6.png)
...
![MySQL set password](/content/mysql/setting-up-a-local-database/windows/installer_7.png)
...
![MySQL configure service](/content/mysql/setting-up-a-local-database/windows/installer_8.png)

The default selections work well unless you have specific requirements. Click **Next** to continue.

The configuration is now complete.

![MySQL apply configuration](/content/mysql/setting-up-a-local-database/windows/installer_9.png)
...
![MySQL command line client](/content/mysql/setting-up-a-local-database/windows/mysql_cli.png)
...
![MySQL list of installers](/content/mysql/setting-up-a-local-database/macos/list_of_installers.png)

Click **Download** next to the macOS DMG Archive.

Next, you will be given the option to create an Oracle Web Account. Feel free to skip this by clicking **No thanks, just start my download** towards the bottom of the page:

![MySQL skip account creation](/content/mysql/setting-up-a-local-database/macos/skip_account_creation.png)

Once the download completes, double click on the file to mount the DMG file:

![MySQL downloaded DMG](/content/mysql/setting-up-a-local-database/macos/downloaded_dmg.png)
...
![MySQL installer package](/content/mysql/setting-up-a-local-database/macos/installer_package.png)

The MySQL installer will launch, displaying the welcome screen:

![MySQL installer welcome](/content/mysql/setting-up-a-local-database/macos/welcome_screen.png)

Click **Continue** to begin the installation procedure.

Next, you will be asked to select the installation type:

![MySQL installer installation type](/content/mysql/setting-up-a-local-database/macos/installation_type.png)
...
![MySQL installer encryption type](/content/mysql/setting-up-a-local-database/macos/encryption_type.png)

Unless you have a strong reason not to, choose **Strong Password Encryption** and click **Next** to continue.

Next, you are prompted to set a password for the MySQL `root` account, which has administrative privileges for the MySQL installation:

![MySQL installer set password](/content/mysql/setting-up-a-local-database/macos/set_password.png)

Choose a strong password and click **Finish** when you are done.

The installer will confirm that the operation was successful:

![MySQL installer complete](/content/mysql/setting-up-a-local-database/macos/complete.png)
...
![MySQL open path file](/content/mysql/setting-up-a-local-database/macos/open_path.png)

At the bottom of the file, add the `/usr/local/mysql/bin` directory:

![Add MySQL path](/content/mysql/setting-up-a-local-database/macos/add_path.png)
...
![MySQL prompt](/content/mysql/setting-up-a-local-database/macos/prompt.png)
