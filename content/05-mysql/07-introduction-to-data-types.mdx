...
If you are using [Prisma Client](/docs/concepts/components/prisma-client) to work with your MySQL databases, you can find a mapping between some of the common MySQL and Prisma types in [Prisma's MySQL data connectors docs](https://www.prisma.io/docs/concepts/database-connectors/mysql#type-mapping-between-mysql-to-prisma-schema).
