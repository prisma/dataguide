---
title: 'How to use create and delete users in MySQL'
metaTitle: "How to use create and delete users in MySQL"
...
In this short guide, we will cover the basics of creating and deleting database users in MySQL. These commands will have you ready to get started on granting database access and establish a foundation for future [role management](https://www.prisma.io/dataguide/mysql/authentication-and-authorization/role-management).

## How do you create MySQL users?
Creating users in MySQL is key for collaborating with others  and for testing access rights and privileges. It is important to note that in order to create users you must login with a user with the privileges described in the [prerequisites](https://www.prisma.io/dataguide/mysql/authentication-and-authorization/user-management-and-authentication#prerequisites).
...
Once your users are created, we have additional informative articles diving deeper in [user role management](https://www.prisma.io/dataguide/mysql/authentication-and-authorization/role-management) in MySQL as well as [user authentication](https://www.prisma.io/dataguide/mysql/authentication-and-authorization/intro-to-authn-and-authz).