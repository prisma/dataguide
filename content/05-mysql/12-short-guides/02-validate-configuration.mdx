...
If you are using Prisma, you can connect with your MySQL server and manage your data using the [MySQL database connector](https://www.prisma.io/docs/orm/overview/databases/mysql#connection-details).
