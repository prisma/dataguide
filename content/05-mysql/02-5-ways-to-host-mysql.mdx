...
There are a number of ways of getting a [MySQL](/intro/database-glossary#mysql) server up and running for your projects.  You can install and manage a server instance yourself or you can take advantage of one of the many providers who offer managed MySQL access.
...
Self-hosting gives you a lot of choice as to where you will install and run your databases.  If you choose one of the options in this section, you can use this guide to learn [how to install MySQL on your systems](/mysql/setting-up-a-local-mysql-database).
...
Your database will not be easily or reliably [available](/intro/database-glossary#availability) to other users. Your own usage of the database will be limited by your hardware and the amount of resources you can spare for MySQL.  These concerns are not typically an issue when testing or developing locally, but are entirely inadequate for anything more complex.

#### Scalability

Hosting on your development machine gives you almost no [scalability](/intro/database-glossary#scaling).  You can change the amount of resources allocated to MySQL, but not much more.  You can upgrade your development machine, but that is neither practical or particularly useful in the long term.
...
Another self-hosting option is to use [Docker](https://www.docker.com/) to run MySQL as a container. Docker allows you run MySQL in an isolated environment on a local or remote machine.
