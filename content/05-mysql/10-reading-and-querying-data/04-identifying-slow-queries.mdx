...
In this article, we'll discuss various way to identify poorly performing queries in MySQL databases.  This will set the groundwork for optimizing these queries and improving their performance.
...
The first thing should do is verify the current state of slow query logging.  If slow query logging is already enabled, you don't have to do anything.
