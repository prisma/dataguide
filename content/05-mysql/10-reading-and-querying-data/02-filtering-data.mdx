...
Prisma Client supports filtering by multiple criteria.  Check out our [documentation on filtering](/docs/concepts/components/prisma-clientfiltering-and-sorting) to learn more.
...
If you are connecting to your database with [Prisma Client](/docs/concepts/components/prisma-client), you can use [aggregations](/docs/concepts/components/prisma-clientaggregation-grouping-summarizing) to compute over and summarize values.
...
If you are connecting to your database with [Prisma Client](/docs/concepts/components/prisma-client), you can use [pagination](/docs/concepts/components/prisma-clientpagination) to iterate through results.
