...
[PostgreSQL’s Feature Matrix](postgresql.org/about/featurematrix/) is a table maintained by PostgreSQL outlining all of its features and which version those features were added in. 
...
You can find PostgreSQL’s feature list in its [Feature Matrix](postgresql.org/about/featurematrix/).
