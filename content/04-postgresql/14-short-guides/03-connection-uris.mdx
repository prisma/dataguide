...
If you are using [Prisma to manage your PostgreSQL database](https://www.prisma.io/docs/orm/overview/databases/postgresql), you need to set a connection URI within a 'datasource' block in your [Prisma schema file](https://www.prisma.io/docs/orm/prisma-schema/overview). You must provide a [connection URI for the 'url' field](https://www.prisma.io/docs/orm/overview/databases/postgresql#example) so that Prisma can connect to your database.
