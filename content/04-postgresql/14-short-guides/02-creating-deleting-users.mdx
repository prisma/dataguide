...
There are [additional options](https://www.postgresql.org/docs/current/app-dropuser.html) that you can include for parameters such as the username to login as to conduct the user drop or including a clause for if the user exists.
