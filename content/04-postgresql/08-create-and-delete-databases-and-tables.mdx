...
When using Prisma to develop with PostgreSQL, you will usually create databases and tables with [Prisma Migrate](https://www.prisma.io/docs/orm/prisma-migrate). You can learn how use it in our guide on [developing with Prisma Migrate](https://www.prisma.io/docs/orm/prisma-migrate/workflows).
