...
In the data model used by Prisma schema, data types are represented by [field types](https://www.prisma.io/docs/reference/tools-and-interfaces/prisma-schema/data-model#defining-fields).  You might also want to take a look at our guide on [mapping fields to a specific native type](https://www.prisma.io/docs/concepts/components/prisma-migrate/supported-types-and-db-features#mapping-fields-to-a-specific-native-type).
