...
metaTitle: "Workgin with dates in PostgreSQL | Prisma's Data Guide"
...
If you are using [Prisma Client](https://www.prisma.io/docs/concepts/components/prisma-client) with PostgreSQL, here's some information about how Prisma Client translates [PostgreSQL's data type](https://www.prisma.io/docs/reference/api-reference/prisma-schema-reference#postgresql-6).
