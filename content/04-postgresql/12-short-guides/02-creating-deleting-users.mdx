...
```
The [options component](https://www.postgresql.org/docs/current/app-createuser.html) of the command is where you can define parameters such as whether this user can create databases, is a superuser, and the need for a password when connecting to the server. 
