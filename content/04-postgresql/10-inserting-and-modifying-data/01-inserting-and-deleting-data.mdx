---
title: 'PostgreSQL Insert and Delete Data'
metaTitle: 'PostgreSQL Delete, Insert, and Update'
metaDescription: "The `INSERT` and `DELETE` commands are how PostgreSQL adds and removes records from tables.  Here we show how to use them to control the data in your tables."
---
