...
You can learn about how to query with Prisma Client in our guide on [CRUD operations](/docs/concepts/components/prisma-client/crud).
...
If using Prisma Client, you can achieve the same results using [select fields](/docs/concepts/components/prisma-client/select-fields).
...
You can learn more about sorting and filtering queries with Prisma Client in our [filtering and sorting documentation](/docs/concepts/components/prisma-client/filtering-and-sorting).
