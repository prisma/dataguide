...
You can learn about how to query with Prisma Client in our guide on [CRUD operations](/docs/concepts/components/prisma-clientcrud).
...
If using Prisma Client, you can achieve the same results using [select fields](/docs/concepts/components/prisma-clientselect-fields).
...
You can [sort your results](/docs/concepts/components/prisma-clientfiltering-and-sorting) with Prisma Client in much the same way as you would in an SQL query.
...
You can filter duplicate rows from your query with Prisma Client by using the [distinct](/docs/concepts/components/prisma-clientaggregation-grouping-summarizing#select-distinct) functionality.
...
You can learn more about sorting and filtering queries with Prisma Client in our [filtering and sorting documentation](/docs/concepts/components/prisma-clientfiltering-and-sorting).
