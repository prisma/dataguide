...
Once you have a PostgreSQL database, you can use [Prisma Client](https://www.prisma.io/docs/orm/prisma-client) to manage it from within your JavaScript or TypeScript applications. Try our [PostgreSQL getting started guide](https://www.prisma.io/docs/getting-started/setup-prisma/start-from-scratch/relational-databases-typescript-postgresql) to get started.
