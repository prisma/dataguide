---
title: 'Setting up a local PostgreSQL database'
metaTitle: 'How to Run and Setup a Local PostgreSQL Database | Prisma'
metaDescription: 'Learn how to set up a PostgreSQL database on Windows, macOS, and Linux by following the step-by-step instructions in this practical guide.'
...
Once you have a PostgreSQL database, you can use [Prisma Client](https://www.prisma.io/docs/concepts/components/prisma-client) to manage it from within your JavaScript or TypeScript applications. Try our [PostgreSQL getting started guide](https://www.prisma.io/docs/getting-started/setup-prisma/start-from-scratch/relational-databases-typescript-postgresql) to get started.
...
![PostgreSQL initial download page](/dataguide-images/postgresql/setting-up-a-local-database/windows/initial_download_page.png)
...
![PostgreSQL available versions](/dataguide-images/postgresql/setting-up-a-local-database/windows/installer_download.png)
...
![PostgreSQL installer greeting](/dataguide-images/postgresql/setting-up-a-local-database/windows/installer_greeting.png)

Click **Next** on the initial page to begin configuring your installation.

On the next page, choose your installation directory:

![PostgreSQL installation directory](/dataguide-images/postgresql/setting-up-a-local-database/windows/installation_directory.png)
...
![PostgreSQL choose components](/dataguide-images/postgresql/setting-up-a-local-database/windows/choose_components.png)

Click **Next** to continue.

Now, choose the location where the database data files will be stored:

![PostgreSQL data directory](/dataguide-images/postgresql/setting-up-a-local-database/windows/data_directory.png)

Click **Next** to accept the default location.

Next, select and confirm an administrative password for the PostgreSQL superuser (called `postgres`):

![PostgreSQL set password](/dataguide-images/postgresql/setting-up-a-local-database/windows/set_password.png)

Click **Next** when you are finished.

Choose the port that the server will listen to:

![PostgreSQL set port](/dataguide-images/postgresql/setting-up-a-local-database/windows/set_port.png)

Click **Next** to accept the default 5432 port.

Now, pick the locale that your database will use:

![PostgreSQL locale](/dataguide-images/postgresql/setting-up-a-local-database/windows/set_locale.png)
...
![PostgreSQL installation summary](/dataguide-images/postgresql/setting-up-a-local-database/windows/installation_summary.png)

If everything looks correct, click **Next**.

Finally, PostgreSQL is ready to be installed:

![PostgreSQL ready to install](/dataguide-images/postgresql/setting-up-a-local-database/windows/ready_to_install.png)
...
![Running psql client](/dataguide-images/postgresql/setting-up-a-local-database/windows/psql.png)
...
![PostgreSQL initial download page](/dataguide-images/postgresql/setting-up-a-local-database/macos/initial_download_page.png)

On the page that follows, in the Mac OS X column, choose the PostgreSQL version you'd like to install:

![PostgreSQL available versions](/dataguide-images/postgresql/setting-up-a-local-database/macos/installer_download.png)
...
![PostgreSQL DMG file](/dataguide-images/postgresql/setting-up-a-local-database/macos/dmg_file.png)
...
![PostgreSQL installer package](/dataguide-images/postgresql/setting-up-a-local-database/macos/installer_package.png)

The PostgreSQL installer will open to the welcome screen:

![PostgreSQL installer welcome](/dataguide-images/postgresql/setting-up-a-local-database/macos/welcome.png)

Click **Next** on the initial page to begin configuring your installation.

On the next page, choose your installation directory:

![PostgreSQL installation directory](/dataguide-images/postgresql/setting-up-a-local-database/macos/installation_directory.png)

Click **Next** to accept the default location.

The next page allows you to choose which components you wish to install. You need the **PostgreSQL Server** and **Command Line Tools** selected at a minimum:

![PostgreSQL choose components](/dataguide-images/postgresql/setting-up-a-local-database/macos/choose_components.png)

Click **Next** to continue.

Now, choose the location where the database data files will be stored:

![PostgreSQL data directory](/dataguide-images/postgresql/setting-up-a-local-database/macos/choose_data_directory.png)

Click **Next** to accept the default location.

On the next page, select and confirm an administrative password for the PostgreSQL superuser (called `postgres`):

![PostgreSQL set password](/dataguide-images/postgresql/setting-up-a-local-database/macos/set_password.png)

Click **Next** when you are finished.

The following page lets you choose the port that the server will listen to:

![PostgreSQL set port](/dataguide-images/postgresql/setting-up-a-local-database/macos/choose_port.png)

Click **Next** to accept the default 5432 port.

Now, pick the locale that your database will use:

![PostgreSQL locale](/dataguide-images/postgresql/setting-up-a-local-database/macos/choose_locale.png)

Click **Next** to use the default locale of your computer.

The configuration portion of the installation is now complete. You can review a summary of the choices you've made:

![PostgreSQL installation summary](/dataguide-images/postgresql/setting-up-a-local-database/macos/installation_summary.png)

If everything looks correct, click **Next**.

PostgreSQL is ready to be installed:

![PostgreSQL ready to install](/dataguide-images/postgresql/setting-up-a-local-database/macos/ready_to_install.png)

Click **Next** to begin the installation process.

The installer will confirm completion when the process completes:

![PostgreSQL installation complete](/dataguide-images/postgresql/setting-up-a-local-database/macos/installation_complete.png)
...
![PostgreSQL open paths file](/dataguide-images/postgresql/setting-up-a-local-database/macos/open_paths_file.png)

Add the path to `bin` directory that you found to the bottom of the file:

![PostgreSQL edit paths file](/dataguide-images/postgresql/setting-up-a-local-database/macos/edit_paths_file.png)
...
![PostgreSQL psql authentication](/dataguide-images/postgresql/setting-up-a-local-database/macos/psql_authentication.png)
