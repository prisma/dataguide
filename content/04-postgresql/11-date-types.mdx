...
If you are using [Prisma Client](/docs/concepts/components/prisma-client) with PostgreSQL, here's some information about how Prisma Client translates [PostgreSQL's date type](https://www.prisma.io/docs/reference/api-reference/prisma-schema-reference#postgresql-6).

</PrismaOutlinks>

## FAQ

<details><summary>What is the date format in PostgreSQL?</summary>
...
<details><summary>What is the `DATE_PART()` function in PostgreSQL?</summary>
...
<details><summary>How does the `to_date` function work in PostgreSQL?</summary>
...
<details><summary>How do you extract a date from a timestamp in PostgreSQL?</summary>
...
<details><summary>How do you truncate a date in PostgreSQL?</summary>
