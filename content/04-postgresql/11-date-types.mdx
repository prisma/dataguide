...
If you are using [Prisma Client](https://www.prisma.io/docs/orm/prisma-client) with PostgreSQL, here's some information about how Prisma Client translates [PostgreSQL's date type](https://www.prisma.io/docs/orm/reference/prisma-schema-reference#postgresql-6).
