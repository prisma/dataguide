...
metaTitle: "5 ways to host PostgreSQL databases | Prisma's Data Guide"
...
There are many ways to acquire a PostgreSQL instance for your projects or organizations to use.  You can learn how to install and configure PostgreSQL yourself or you can pay service providers to manage your PostgreSQL databases for you.
...
Another self-hosting option is to use Docker to run PostgreSQL as a container. Docker allows you run PostgreSQL in an isolated environment on a local or remote machine.
...
* [Datebase Labs](https://www.databaselabs.io/pricing/)
...
![Chart comparing PostgreSQL hosting options](/content/postgresql/ways-to-host-postgresql-databases/comparison-chart.png)
