...
**Note:** If you are connecting to your database with [Prisma Client](/docs/concepts/components/prisma-client), you can perform upsert operations using the dedicated [upsert operation](/docs/concepts/components/prisma-client/crud#upsert).
