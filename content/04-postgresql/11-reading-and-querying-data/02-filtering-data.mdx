...
metaTitle: 'How to filter query results in PostgreSQL'
metaDescription: "PostgreSQL provides a large number of ways to constrain the results that your queries return.  This guide introduces and demonstrates how to filter queries to return only the data you're interested in."
---
...
**Note:** If you are connecting to your database with [Prisma client](https://www.prisma.io/docs/reference/tools-and-interfaces/prisma-client), you can use [filtering conditions](https://www.prisma.io/docs/reference/tools-and-interfaces/prisma-client/filtering) to narrow the results of your queries.
...
**Note:** If you are connecting to your database with [Prisma client](https://www.prisma.io/docs/reference/tools-and-interfaces/prisma-client), you can use [aggregations](https://www.prisma.io/docs/reference/tools-and-interfaces/prisma-client/aggregations) to compute over and summarize values.
...
**Note:** If you are connecting to your database with [Prisma client](https://www.prisma.io/docs/reference/tools-and-interfaces/prisma-client), you can use [pagination](https://www.prisma.io/docs/reference/tools-and-interfaces/prisma-client/pagination) to iterate through results.
