...
This same information can also be encoded into a [PostgreSQL *connection string*](https://www.prisma.io/dataguide/postgresql/short-guides/connection-uris).  A connection string provides the same information in a single URI string that uses certain characters as delimiters between the different fields.
