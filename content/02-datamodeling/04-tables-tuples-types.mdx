...
metaTitle: "Tables, Tuples, and Data Types in Databases | Data Modeling"
metaDescription: "Effective database design depends first on well-thought-out and well-formulated table designs. Here we discuss data types, tuples, tables, and more."
---
## Introduction
...
Coming up in [*Correctness and Constraints*](https://www.prisma.io/dataguide/datamodeling/correctness-constraints), we'll cover the tools relational databases use to define and enforce correctness at all levels of data storage.
