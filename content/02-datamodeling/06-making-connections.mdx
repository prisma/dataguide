...
![Expanding the libraries schema to begin tracking provenance for individual books.](../dataguide-images/modeling/libraries-provenances.png)
...
![Adding junction tables to the model allows the relationships between patrons and books, and patrons and libraries, to be fully represented.](../dataguide-images/modeling/libraries-full.png)
