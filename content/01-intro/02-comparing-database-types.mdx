...
![Diagram of a hierarchical database](/dataguide-images/intro/database-type-comparison/hierarchical.png)
...
![Diagram of a network database](/dataguide-images/intro/database-type-comparison/network.png)
...
![Diagram of relational schema used to map entities for a school](/dataguide-images/intro/database-type-comparison/relational.png)
...
![Diagram of key-value data store](/dataguide-images/intro/database-type-comparison/key-value.png)
...
![Diagram of document database](/dataguide-images/intro/database-type-comparison/document.png)
...
![Diagram of a graph database structure](/dataguide-images/intro/database-type-comparison/graph.png)
...
![Diagram of column-family database structure](/dataguide-images/intro/database-type-comparison/column.png)
...
![Single metric time series databases](/dataguide-images/intro/database-type-comparison/time-series-single-metric.png)
...
![Multi-metric time series databases](/dataguide-images/intro/database-type-comparison/time-series-multi-metric.png)
