...
authors: ['nikolasburk', 'schickling']
---
...
[Database administrators](https://www.prisma.io/dataguide/intro/what-are-databases#dbas-database-administrators), or DBAs, are individuals who are responsible for keeping data systems running smoothly. They are responsible for planning new systems, installing and configuring software, setting up database systems for other parties, and managing performance.
...
Database management systems (DBMS) are software systems used to store, retrieve, and run queries on data. They serve as an interface between end-users and a database to perform [CRUD](https://www.prisma.io/dataguide/intro/what-are-databases#interacting-with-databases-to-manage-your-data) operations.
