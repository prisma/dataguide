...
<dt><strong>Flat-file database</strong></dt>
<dd>
...
<dt><strong>HTAP database</strong></dt>
<dd>
...
<dt><strong>Hierarchical database</strong></dt>
<dd>
...
<dt><strong>Horizontal scaling</strong></dt>
<dd>
...
<dt><strong>Hot backup</strong></dt>
<dd>
...
<dt><strong>In-memory database</strong></dt>
<dd>
...
<dt><strong>Inner join</strong></dt>
<dd>
...
<dt><strong>Interactive transactions</strong></dt>
<dd>
...
<dt><strong>Isolation levels</strong></dt>
<dd>
...
<dt><strong>Key-value database</strong></dt>
<dd>
...
<dt><strong>Migration (database, schema)</strong></dt>
<dd>
...
<dt><strong>Multiversion concurrency control (MVCC)</strong></dt>
<dd>
...
<dt><strong>Network database</strong></dt>
<dd>
...
<dt><strong>Nonrepeatable read</strong></dt>
<dd>
...
<dt><strong>OLAP database</strong></dt>
<dd>
...
<dt><strong>OLTP database</strong></dt>
<dd>
...
<dt><strong>Object relational impedance mismatch</strong></dt>
<dd>
...
<dt><strong>Outer join</strong></dt>
<dd>
...
<dt><strong>Parameterized query</strong></dt>
<dd>
...
<dt><strong>Persistent storage</strong></dt>
<dd>
...
<dt><strong>Pessimistic concurrency control</strong></dt>
<dd>
...
<dt><strong>Phantom read</strong></dt>
<dd>
...
<dt><strong>Query builder</strong></dt>
<dd>
...
<dt><strong>Query language</strong></dt>
<dd>
...
<dt><strong>Query planner</strong></dt>
<dd>
...
<dt><strong>Raft consensus algorithm</strong></dt>
<dd>
...
<dt><strong>Read committed isolation level</strong></dt>
<dd>
...
<dt><strong>Read operation</strong></dt>
<dd>
...
<dt><strong>Read uncommitted isolation level</strong></dt>
<dd>
...
<dt><strong>Relational database</strong></dt>
<dd>
...
<dt><strong>Relational database management system (RDBMS)</strong></dt>
<dd>
...
<dt><strong>Repeatable read isolation level</strong></dt>
<dd>
...
<dt><strong>Right join</strong></dt>
<dd>
...
<dt><strong>Role-based access control (RBAC)</strong></dt>
<dd>
...
<dt><strong>Sanitizing input</strong></dt>
<dd>
...
<dt><strong>Serializable isolation level</strong></dt>
<dd>
...
<dt><strong>Serialization anomaly</strong></dt>
<dd>
...
<dt><strong>Stale data</strong></dt>
<dd>
...
<dt><strong>Standard column family</strong></dt>
<dd>
...
<dt><strong>Storage engine</strong></dt>
<dd>
...
<dt><strong>Stored procedure</strong></dt>
<dd>
...
<dt><strong>Super column family</strong></dt>
<dd>
...
<dt><strong>Table aliases</strong></dt>
<dd>
...
<dt><strong>Three tier architecture</strong></dt>
<dd>
...
<dt><strong>Two-phase commit</strong></dt>
<dd>
...
<dt><strong>Two-phase locking</strong></dt>
<dd>
...
<dt><strong>Vertical scaling</strong></dt>
<dd>
...
<dt><strong>Volatile storage</strong></dt>
<dd>
...
<dt><strong>Wide-column store</strong></dt>
<dd>
...
<dt><strong>Write operation</strong></dt>
<dd>
