...
If you are using [Prisma Client](/docs/concepts/components/prisma-client) with SQL Server, you can use the [SQL Server connector](https://www.prisma.io/docs/concepts/database-connectors/sql-server) to connect, map your models, and manage your data.
