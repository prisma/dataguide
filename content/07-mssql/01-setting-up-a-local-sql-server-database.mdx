...
If you are using [Prisma Client](https://www.prisma.io/docs/concepts/components/prisma-client) with SQL Server, you can use the [SQL Server connector](https://www.prisma.io/docs/concepts/database-connectors/microsoft-sql-server) to connect to, map your models, and manage your database connections.
