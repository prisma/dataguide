...
If you are using [Prisma Client](https://www.prisma.io/docs/orm/prisma-client) with SQL Server, you can use the [SQL Server connector](https://www.prisma.io/docs/orm/overview/databases/sql-server) to connect, map your models, and manage your data.
