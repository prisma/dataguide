...
- Testing whether the database is accepting connections
...
For example, in Postgres, the `EXPLAIN` command shows the query plan for the statements under consideration and will display estimated execution cost. This is an estimate of how long it will take the query to run.
