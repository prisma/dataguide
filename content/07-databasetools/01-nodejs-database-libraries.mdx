---
title: 'Top 11 Node.js ORMs, query builders & other database libraries in 2020'
metaTitle: 'Top 11 Node.js ORMs, query builders & other database libraries in 2020'
...
Postgres, MySQL, MariaDB, SQLite and Microsoft SQL Server. It also supports CockroachDB using an external package.
...
Mongoose is a popular and well maintained Node.js object modeling tool for MongoDB. It allows you to model your data using schemas and it includes built-in type casting, validation, query building, and business logic hooks.
