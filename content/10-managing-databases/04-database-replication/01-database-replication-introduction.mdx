...
To perform database migrations with [Prisma Client](/docs/concepts/components/prisma-client), use the [Prisma Migrate tool](https://www.prisma.io/docs/concepts/components/prisma-migrate).  Prisma Migrate analyzes your schema files, generates migration files, and applies them to target databases.
