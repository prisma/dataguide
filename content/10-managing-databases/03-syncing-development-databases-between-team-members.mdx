...
If you are using [Prisma Client](https://www.prisma.io/docs/concepts/components/prisma-client), you can use the [integrated seeding functionality](https://www.prisma.io/docs/guides/migrate/seed-database) to easily populate a database.
