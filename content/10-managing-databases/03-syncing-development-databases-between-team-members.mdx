...
If you are using [Prisma Client](/docs/concepts/components/prisma-client), you can use the [integrated seeding functionality](https://www.prisma.io/docs/guides/database/seed-database) to easily populate a database.
