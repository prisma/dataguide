...
If you are using [Prisma Client](https://www.prisma.io/docs/orm/prisma-client), you can [configure logging](https://www.prisma.io/docs/orm/prisma-client/observability-and-logging/logging) to control how logs are generated.
...
If you are using [Prisma Client](https://www.prisma.io/docs/orm/prisma-client), the [error code reference](https://www.prisma.io/docs/orm/reference/error-reference#error-codes) can help diagnose what errors mean and how to fix them.
