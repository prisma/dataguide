...
If you are using [Prisma Client](/docs/concepts/components/prisma-client), you can [configure logging](/docs/concepts/components/prisma-clientworking-with-prismaclient/logging) to control how logs are generated.
