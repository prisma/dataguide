...
The [Prisma Data Platform](https://www.prisma.io/data-platform) can help simplify access to your database in production environments.  If you are using [Prisma Client](/docs/concepts/components/prisma-client) to manage your database connections, the Prisma Data Platform may help you manage your production workloads more easily.
