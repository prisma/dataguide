...
[Prisma Client](https://www.prisma.io/docs/orm/prisma-client), check out the matching section in [Prisma's documentation on advanced migration scenarios](https://www.prisma.io/docs/orm/prisma-migrate/workflows/customizing-migrations).
