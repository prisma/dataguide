...
[Prisma Client](/docs/concepts/components/prisma-client), check out the matching section in [Prisma's documentation on advanced migration scenarios](https://www.prisma.io/docs/guides/database/developing-with-prisma-migrate/customizing-migrations).
