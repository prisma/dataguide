...
If you're using Prisma Client, you can use [raw database access](/docs/concepts/components/prisma-clientraw-database-access) to send SQL directly to your database.
