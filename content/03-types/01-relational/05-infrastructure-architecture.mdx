...
With a CQRS design pattern, you can separate your concerns and database responsibilities that single database would undertake in a monolithic architecture.
