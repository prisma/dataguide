...
With a CQRS design pattern, you can separate your concerns and database responsibilities that in a monolithic architecture a single database would undertake. 
