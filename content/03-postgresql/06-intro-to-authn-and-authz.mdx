...
metaDescription: "An introduction to authorization and authentication in PostgreSQL"
---
...
Follow our guide on [configuring authentication in PostgreSQL](https://dataguide.prisma.io/postgresql/configuring-user-authentication) to learn how to configure effective `pg_hba.conf` policies.
