...
## [ Sidebar ] Functions vs Procedures
...
<footnote> <note> If you are more familiar with a C-family language than you are with PostgreSQL,</br> the <inlineCode>||</inlineCode> might throw you. That's concatenation here.</note> <text> <i>"^1"</i> </text> </footnote>
