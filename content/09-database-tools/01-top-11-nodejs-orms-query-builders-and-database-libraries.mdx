...
Mongoose is a popular and well maintained Node.js object modeling tool for MongoDB. Stricly speaking, Mongoose is an _object document mapper_, because Mongoose is a document based database. It allows you to model your data using schemas and it includes built-in type casting, validation, query building, and business logic hooks.
