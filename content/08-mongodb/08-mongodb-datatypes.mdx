...
[Here](https://www.prisma.io/dataguide/mongodb/mongodb-datatypes#date) is an example of inserting data using each method and how that data is returned from a query.
