...
The need for data encryption is even more paramount for organizations handling personally identifiable information (PII), financial, health, or government information. In this article, we discuss why you should encrypt your data in addition to robust [authentication](/intro/database-glossary#authentication) and [authorization](/intro/database-glossary#authorization) measures, the different types of encryption in [MongoDB](/intro/database-glossary#mongodb), and encryption best practice.
...
MongoDB Atlas encryption at rest and CSFLE have built-in guides to rotate the required keys for each KMS cloud provider you might be using: [AWS KMS](https://docs.atlas.mongodb.com/tutorial/security-aws-kms-rotate-key/), [Azure Vault](https://docs.atlas.mongodb.com/tutorial/security-azure-kms-rotate-key/), and [Google KMS](https://docs.atlas.mongodb.com/tutorial/security-gcp-kms-rotate-key/). If you are self-hosting MongoDB, there are guides for conducting [manual key rotation](https://docs.mongodb.com/manual/tutorial/rotate-encryption-key/) and also MongoDB's [Ops Manager](https://docs.opsmanager.mongodb.com/current/tutorial/rotate-master-kmip-keys/index.html) and [Cloud Manager](https://docs.cloudmanager.mongodb.com/tutorial/rotate-master-kmip-keys/index.html) platforms. 
