...
Throughout this article, we'll use a [collection](/intro/database-glossary#collection) called `students` and a collection called `teachers`, both stored inside of a database called `school`.
