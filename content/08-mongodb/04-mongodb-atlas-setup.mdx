...
You can also enable Encryption At Rest from the Wired Tiger storage engine with whichever preferred cloud provider.

</details>

<details><summary>How can you connect MongoDB Atlas to Tableau?</summary>

You can [connect MongoDB Atlas to Tableau Desktop](https://www.mongodb.com/docs/atlas/tutorial/connect-bic-tableau/#connect-from-tableau-desktop) with the BI Connector for Atlas. The BI Connector is additional paid for tool that can only be used for MongoDB M10+ clusters.
...
MongoDB Atlas supports a global cluster configuration for your databases. This assures the ability to distribute data globally via cross-region replication, enabling multi-region fault tolerance and responsive read access.
