...
![Create Cluster](/dataguide-images/mdb-atlas-setup/create-cluster-button.png)
...
![Cluster Type](/dataguide-images/mdb-atlas-setup/cluster-type.png)
...
![Global Cluster](/dataguide-images/mdb-atlas-setup/global-cluster.png)
...
![Cloud Provider & Region](/dataguide-images/mdb-atlas-setup/cloud-provider-region.png)
...
![Cluster Tier](/dataguide-images/mdb-atlas-setup/cluster-tier.png)
...
![Base Price](/dataguide-images/mdb-atlas-setup/base-price.png)
...
![Additional Settings](/dataguide-images/mdb-atlas-setup/additional-settings.png)
...
![Create Name](/dataguide-images/mdb-atlas-setup/cluster-name.png)
...
MongoDB Atlas has [built-in monitoring for database metrics](https://www.mongodb.com/basics/how-to-monitor-mongodb-and-what-metrics-to-monitor). Within the clusters view of your MongoDB Atlas dashboard, there is a _View Monitoring_ section.
