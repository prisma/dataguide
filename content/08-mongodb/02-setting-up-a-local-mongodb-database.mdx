...
metaTitle: 'How to Install and Set Up a Local MongoDB Database'
...
![MongoDB download page](/dataguide-images/mongodb/setting-up-a-local-database/windows/01_download_page.png)
...
![MongoDB installer greeting](/dataguide-images/mongodb/setting-up-a-local-database/windows/02_installer_welcome.png)
...
![MongoDB EULA agreement](/dataguide-images/mongodb/setting-up-a-local-database/windows/03_accept_eula.png)

Click **Next** to continue.

The next page allows you to choose which components you wish to install:

![MongoDB installation type](/dataguide-images/mongodb/setting-up-a-local-database/windows/04_select_installation_type.png)
...
![MongoDB service configuration](/dataguide-images/mongodb/setting-up-a-local-database/windows/05_service_config.png)

The default values should work well for most scenarios. Click **Next** when you are satisfied with your selections.

Next, choose whether you want to install [MongoDB Compass](https://www.mongodb.com/products/compass), a graphical interface that you can use to connect to and manage MongoDB servers. This component is optional:

![MongoDB compass installation](/dataguide-images/mongodb/setting-up-a-local-database/windows/06_compass_installation.png)
...
![MongoDB ready to install](/dataguide-images/mongodb/setting-up-a-local-database/windows/07_ready_to_install.png)
...
![MongoDB create data directory](/dataguide-images/mongodb/setting-up-a-local-database/windows/09_make_data_dir.png)
...
![MongoDB run server](/dataguide-images/mongodb/setting-up-a-local-database/windows/10_run_mongo_server.png)
...
![MongoDB waiting for connections](/dataguide-images/mongodb/setting-up-a-local-database/windows/11_waiting_for_connections.png)
...
![MongoDB run shell](/dataguide-images/mongodb/setting-up-a-local-database/windows/12_run_mongo_shell.png)

Once the shell connects to the server, it will print information about the connection and drop you into a MongoDB prompt:

![MongoDB connect to database](/dataguide-images/mongodb/setting-up-a-local-database/windows/13_connect_to_db.png)

To verify that the server is responding to commands, run the `show dbs` command:

![MongoDB show_dbs](/dataguide-images/mongodb/setting-up-a-local-database/windows/14_show_dbs.png)
...
![MongoDB compass connect](/dataguide-images/mongodb/setting-up-a-local-database/windows/15_compass_connect.png)
...
![MongoDB compass running](/dataguide-images/mongodb/setting-up-a-local-database/windows/16_compass_running.png)
...
![MongoDB download page](/dataguide-images/mongodb/setting-up-a-local-database/macos/download_installer.png)
...
![MongoDB extract tarball](/dataguide-images/mongodb/setting-up-a-local-database/macos/extract_tarball.png)
...
![MongoDB copy executables](/dataguide-images/mongodb/setting-up-a-local-database/macos/copy_executables.png)
...
![MongoDB create data directory](/dataguide-images/mongodb/setting-up-a-local-database/macos/create_data_directory.png)
...
![MongoDB create log directory](/dataguide-images/mongodb/setting-up-a-local-database/macos/create_log_directory.png)
...
![MongoDB reassign ownership](/dataguide-images/mongodb/setting-up-a-local-database/macos/assign_owner.png)
...
![MongoDB start server](/dataguide-images/mongodb/setting-up-a-local-database/macos/start_server.png)
...
![MongoDB execution blocked](/dataguide-images/mongodb/setting-up-a-local-database/macos/execution_blocked.png)
...
![MongoDB allow execution](/dataguide-images/mongodb/setting-up-a-local-database/macos/allow_execution.png)
...
![MongoDB confirm execution](/dataguide-images/mongodb/setting-up-a-local-database/macos/confirm_execution.png)
...
![MongoDB run_shell](/dataguide-images/mongodb/setting-up-a-local-database/macos/run_shell.png)
...
![MongoDB shell connected](/dataguide-images/mongodb/setting-up-a-local-database/macos/shell_connected.png)
...
![MongoDB show databases](/dataguide-images/mongodb/setting-up-a-local-database/macos/show_dbs.png)
...
![MongoDB install compass](/dataguide-images/mongodb/setting-up-a-local-database/macos/install_compass.png)

Occasionally, the installer will run into an error, as shown above, but usually it does not affect the actual installation.

The initial screen will give you the opportunity to connect to a running MongoDB server by providing a connection string:

![MongoDB compass connect](/dataguide-images/mongodb/setting-up-a-local-database/macos/compass_connect.png)
...
![MongoDB compass connect](/dataguide-images/mongodb/setting-up-a-local-database/macos/compass_running.png)
