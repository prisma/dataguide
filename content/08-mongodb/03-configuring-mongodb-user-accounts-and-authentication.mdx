...
db.getUsers()
```
More details can be seen [here](https://www.prisma.io/dataguide/mongodb/configuring-mongodb-user-accounts-and-authentication#how-do-you-show-existing-users).
...
The following demonstrates the syntax to use, and more detail can be found [here](https://www.prisma.io/dataguide/mongodb/authorization-and-privileges#what-roles-are-available-in-mongodb-by-default).
