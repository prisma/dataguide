...
With MongoDB's document model, you are able to store data in embedded documents. Check out how you can find, create, update, and delete [composite types with the Prisma Client](/docs/concepts/components/prisma-client/composite-types), and model your data by [defining fields in your Prisma Schema](https://www.prisma.io/docs/concepts/components/prisma-schema/data-model#defining-fields). 
