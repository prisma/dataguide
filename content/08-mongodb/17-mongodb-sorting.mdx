...
metaTitle: "Sorting data in MongoDB"
metaDescription: "Learn how to sort data in ascending and descending order, with single or multiple fields."
...
MongoDB can use additional fields to control sorting for cases where the primary sort field contains duplicates.  To do so, specify additional fields and their sort order in the document provided to the `sort()` function.
